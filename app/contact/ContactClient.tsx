        ...
        >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
            <div>
              ...
              <input id="contact-name" name="name" type="text" placeholder="First and last name" required style={inputStyle} />
            </div>
            <div>
              <label htmlFor="contact-email" style={labelStyle}>Your email</label>
              <input id="contact-email" name="email" type="email" placeholder="you@example.com" required style={inputStyle} />
            </div>
          </div>
          ...
          <div>
            ...
            <input id="contact-subject" name="subject" type="text" placeholder="What's this about?" style={inputStyle} />
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: 16 }}>
            {error && (
              <span style={{ fontSize: 13, color: '#b8302a', fontFamily: 'var(--font-serif)', fontStyle: 'italic' }}>
                {error}
              </span>
            )}
            {submitted && (
